...
//
// Vendored for ABX from scripty.sol's copy (github.com/intartnft/scripty.sol,
// contracts/scripty/utils/DynamicBuffer.sol), itself vendored from ethier. The only ABX
// change is pinning the pragma to the repo's 0.8.28; the code is otherwise unmodified.
...
library DynamicBuffer {
    ...
    function appendSafeBase64(bytes memory buffer, bytes memory data, bool fileSafe, bool noPadding)
        internal
        pure
    {
