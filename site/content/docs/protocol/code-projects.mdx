...
On OP Stack networks such as Base, `block.prevrandao` comes from the L1 origin and may remain the same
across several L2 blocks. Do not treat it as fresh entropy for each L2 block.
